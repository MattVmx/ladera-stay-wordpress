...
**Current execution status:** Complete - 10 of 10 passed  
...
| TC-INQ-010 | Pass | After BUG-INQ-001 was fixed, Chrome rejected 2026-08-10 to 2026-08-13 as earlier than the minimum allowed date, focused the arrival field, and WordPress showed no inquiries (`All (0)`). | [BUG-INQ-001](BUG_REPORTS.md#bug-inq-001---past-stay-dates-are-accepted) |
